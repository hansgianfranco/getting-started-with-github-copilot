...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for competitive soccer matches and develop teamwork",
    ...
    "Drama Club": {
        "description": "Practice acting, improv, and prepare for theater performances",
    ...
    "Debate Team": {
        "description": "Develop research and public speaking skills through debates",
